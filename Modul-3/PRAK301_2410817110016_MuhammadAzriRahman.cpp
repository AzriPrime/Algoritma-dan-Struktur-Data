...
int main() 
{
    do {
        ...
        switch(pil) {
            ...
            case 3 :
                hapusDepan();
                cout << "Data \""<<dataTerhapus<<"\" yang berada di depan telah berhasil dihapus. " << endl;
                break;
            case 4 :
                hapusBelakang();
                cout << "Data \""<<dataTerhapus<<"\" yang berada di belakang telah berhasil dihapus. " << endl;
                break;
            case 5 :
                tampilkan();
                break;
            ...
            default :
                cout << "\nTERIMA KASIH" << endl;
                cout << "Program was made by Muhammad Azri Rahman (2410817110016)." << endl;
        }
    ...
    void cariData() {
        ...
        } else cout << "Tidak terdapat data paa Linked List." <<endl;
    }
